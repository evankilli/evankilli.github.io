...
1. access to such platforms, allowing a larger number of users to enter the field,
2. access to data, bettering the availability of high quality data for GIS analysis, and
3. access to the code behind programs, allowing for users to better understand how the tools they are using work.
