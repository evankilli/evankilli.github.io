...
As scientists, we are obliged to help, whether that be to help further understanding, or to help create vital interventions to alleviate human (and environmental) suffering. While important power differentials can create further problems - and these should certainly not be ignored, I feel that we have an ethical obligation to do so in *some* form, and doing this requires a deeper study. It is not enough to study healthcare access in Tanzania, we must also study the deeper context of colonialism and neo-colonialism to understand such analyses and to be better able to identify a) appropriate uses of VGI, b) uncertainties in methods and results, c) pertinent results that may relate back to both the immediate crisis and deeper context, and d) potential interventions.
