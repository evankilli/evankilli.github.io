...
Unlike some other analyses from my time at Middlebury on this page, conducted as a part of [Prof. Joe Holler's](https://josephholler.github.io/) spring 2021 class "Open Source GIScience," this analysis is a personal project used for part of a project for another class, *The Architecture of Planning and Place*, as well as practice and personal enjoyment of PostGIS and SQL.

This analysis aims to quantify access to public transportation in Stockholm, Sweden with easily available, open source data, all as part of a project looking at Stockholm as a successful urban environment. By taking advantage of the large number of features available to query in [OpenStreetMap](https://www.openstreetmap.org/#map=13/39.9209/-75.1324&layers=T), one is able to query all residential (or possibly residential) buildings in a region and evaluate their distance to transit.

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/stockholm_metro.gif" title="Geographic Stocholm metro map" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    A geographic map of Stockholm's metro; see <a href="https://www.cityrailtransit.com" target="_blank">CityRailTransit</a> for more maps like it.
</div>
...
-- joining reshood_cnt w neighborhood geometries to get a map of neighborhood with counts of residences
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/rail_access2.png" title="Access to Rail Transit" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/transit_access.png" title="Access to All Transit" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    On the left, a map of access to rail transit in Stockholm, with stations and buffers. On the right, a map of access to all transit.
</div>
