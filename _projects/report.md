...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/content/RP-Kang/original_map.png" title="Output from original code" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/content/RP-Kang/edited_map.png" title="Outputs from edited code" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Maps of access to healthcare resources in Chicago, IL, based on the original script used in this reproduction (left) and an updated version thereof better accounting for road networks outside the city (right).
</div>
