...
The entire script for this analysis is available [here](https://github.com/evankilli/evankilli.github.io-old).
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/wards_w_hosp.png" title="Wards with Medical Care" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
      A map of hospitals, clinics, and doctors overlaid over Dar-es-Salaam's wards.
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/resilience.png" title="Medical Access in Dar-es-Salaam" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    A map showing the proportion of homes in Dar-es-Salaam's wards within one mile of medical care.
</div>
