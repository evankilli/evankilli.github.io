...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/content/RE-Rosgen/siteandbuffer.png" title="Access to Rail Transit" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/content/RE-Rosgen/slope.png" title="Access to All Transit" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/content/RE-Rosgen/banklines.png" title="Access to All Transit" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/content/RE-Rosgen/valleylines.png" title="Access to Rail Transit" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/content/RE-Rosgen/crosssec_w_bf.png" title="Access to All Transit" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/content/RE-Rosgen/longprof_w_slope.png" title="Access to All Transit" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Clockwise from top left: study region map of elevation, study region map of slope, study region map of bank centerlines, study region map of valley centerlines, study site cross-section, and study site longitudinal profile.
</div>
